"""Business Standard — top stories. Mixed topics, so we apply the keyword filter."""
import yaml
...
def fetch() -> list[dict]:
    ...
    return fetch_rss(FEED_URL, source_name="Business Standard", keyword_filter=keywords)
